...
ActiveRecord::Schema.define(:version => 2) do
  ...
  create_table "articles", :force => true do |t|
    ...
    t.column "article_date",  :datetime,                :null => false
    t.column "article_mtime", :datetime,                :null => false
  ...
  create_table "dona_cas", :force => true do |t|
    t.column "article_id",  :integer
    t.column "category_id", :integer
    t.column "task",        :integer
  end

  create_table "dona_daas", :force => true do |t|
    t.column "article_id",        :integer
